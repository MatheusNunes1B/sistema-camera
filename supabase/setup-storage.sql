-- PÂNICO DE DADOS — configuração do Supabase para demonstração.
-- Execute este arquivo no SQL Editor do seu projeto Supabase.
-- Para produção, utilize autenticação e políticas restritas por usuário/escola.
...
drop policy if exists "demo allows photo deletion" on storage.objects;
create policy "demo allows photo deletion"
